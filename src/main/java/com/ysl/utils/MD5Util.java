...
public class MD5Util {
  ...
  public static void main(String args[]) {
    ...
    ciphertext = MD5Util.generate(plaintext);
    System.out.println("加盐后MD5：" + ciphertext);
    ciphertext = MD5Util.generate(plaintext);
    System.out.println("加盐后MD5：" + ciphertext);
     ...
     * 其中某次DingSai字符串的MD5值
     */
    String[] tempSalt = {"235c0902d37a64387ba8f821641a58085f89d91b3529e109" ,
        "29227642e87de45688827b6d226a3b576276f9d44152d565" ,
        "71424334689b56b76de8119f98af00a49344240962788433"};
